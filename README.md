# Sales-performance-for-Aurora-Logistics
Interactive Excel dashboard analyzing year-on-year sales performance, product trends, and regional insights.
# Sales Performance Dashboard — Excel Project

## Executive Summary
This project analyzes year-on-year sales and profit performance for a fictional retail company using Microsoft Excel.  

The company recorded a **20.4% increase in total sales** and a **14.2% increase in profit** compared to the previous year.  
The dashboard highlights product category trends, regional distribution of sales, and quarterly performance patterns.  

While growth is strong overall, profit margins and regional concentration suggest strategic areas for improvement.

## Dashboard Preview
<p align="center">
  <img src="https://i.postimg.cc/9Xww3z3b/sales-vs-profit.jpg" alt="Sales Dashboard" width="800"/>
</p>
...
- **Total Sales** grew from `609,205.6` to `733,215.3` (+20.4%).
- **Profit** rose from `81,795.2` to `93,439.3` (+14.2%).
- Profit grew at a slower rate than sales, suggesting potential cost or margin issues.
